...
{ 
    ...
    msgid2 = msgget(1012, 0666 | IPC_CREAT); //server will use this to send
    message.mesg_type = 1; 
    message.cl = msgid2; 
    ...
    while(1) {
        ...
        // for (int i = 0; i<n; i++) {
            ...
            m = m+ micros;
        // }
        // printf("Total time B = %lu seconds and %lu micros\n", s, m);
        // printf("Average time B = %lu seconds and %lu micros\n", s/n, m/n);
